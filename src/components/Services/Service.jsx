    ...
    return (
        <div>
            <div className='p-2 md:h-[434px] lg:h-[495px] xl:h-[491px] 2xl:h-auto lg:p-4 shadow-md rounded-md flex flex-col justify-between flex-1'>
                ...
                <Link to={`/services/${id}`}>
                <button className='my-2 px-3 py-2 rounded-md bg-secondery hover:bg-accent transition duration-200 font-semibold text-contrast    text-base 2xl:text-2xl'>Show Detail</button>
                </Link>
                </div>
            </div>
        </div>
